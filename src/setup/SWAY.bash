#!/bin/bash
# Original source: https://github.com/Miriway/Miriway/blob/main/example-configs/miriway-config-SWAY.bash
# Modified by: https://github.com/kyle-zst
# Changes: Removed interactive Yes/No prompt for automated execution
...
# Removed interactive prompt - proceeding automatically
echo Proceeding...
